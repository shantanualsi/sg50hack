...
//	private static Logger log = LoggerFactory.getLogger(NearestAttractionsMock.class.getName());
	...
	private static void init() {
		...
		universalStudios.setImg("http://192.168.1.8:8080/images/universal-studios.jpg");
		...
		madameTussads.setImg("http://192.168.1.8:8080/images/madame-tussauds.jpg");
		...
		seaAquarium.setImg("http://192.168.1.8:8080/images/sea-aquarium.jpg");
		...
		skylineLuge.setImg("http://192.168.1.8:8080/images/skyline-luge.jpg");
		...
		trickEyeMuseum.setImg("http://192.168.1.8:8080/images/trick-eye-museum.jpg");
		...
		adventureCoveWaterpark.setImg("http://192.168.1.8:8080/images/adventure-cove-waterpark.jpg");
		...
		skyTower.setCol(col);
		skyTower.setCwd(cwd);
		skyTower.setImg("http://192.168.1.8:8080/images/tiger-sky-tower.jpg");
		...
		insectKingdom.setImg("http://192.168.1.8:8080/images/butterfly-park-and-insect-kingdom.jpg");
		...
		adventureLand4D.setImg("http://192.168.1.8:8080/images/adventureland-4d.jpg");
